...
export default function DeleteItem({ cartItemId, productTitle }: { cartItemId: string, productTitle: string }) {
            ...
            <DialogContent className="sm:max-w-[425px]">
                ...
                <DialogFooter>
                    <Button
                        ...
                        className="flex-1 h-12 rounded-full bg-rose-300 p-0 shadow-sm hover:bg-rose-400"
                        size={"lg"}
                    >
