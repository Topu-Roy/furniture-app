...
export const products: ProductType[] = [
  ...
  {
    productTitle:
      "Classic Rocking Chair - Additional Angle with Cushioned Seat",
  ...
  {
    productTitle:
      "Mid-century Armchair - Alternate Design with Leather Upholstery",
  ...
  {
    productTitle:
      "Contemporary Floor Lamp - Second Variation with Adjustable Height",
  ...
  {
    productTitle:
      "Velvet Upholstered Sofa - Additional View with Throw Pillows",
    image: "/products/Sofa - Brown - Velvet Upholstered Sofa (1).jpg",
    price: 1499,
    category: "Sofa",
    tag: "Luxurious",
  ...
  {
    productTitle:
      "Minimalist Bedside Table - Second Option with Built-in USB Charger",
  ...
  {
    productTitle:
      "Rustic Wooden Dining Table - Additional View with Matching Bench",
